<template>
    <div>
        <el-skeleton :loading="loading" animated>
            <template #template>
                <el-skeleton-item variant="image" class="w-screen flex justify-center" :style="{height: carouselHeight}" />
            </template>
            <template #default>
                <el-carousel class="w-screen" v-if="!isMobile" type="card" trigger="click">
                    <el-carousel-item v-for="item in banners" :key="item.bannerId">
                        <el-image class="card-radius" :src="item.pic" />
                    </el-carousel-item>
                </el-carousel>
                <el-carousel v-else class="w-screen" :height="carouselHeight" indicator-position="none">
                    <el-carousel-item v-for="item in banners" :key="item.bannerId">
                        <img :src="item.pic" />
                    </el-carousel-item>
                </el-carousel>
