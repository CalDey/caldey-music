            ...
            <div class="flex justify-between items-center z-20">
                ...
                <div class="mr-2 flex items-center">
                    ...
                    <div class="cursor-pointer ml-2 z-20">
                        <icon-svg class="w-6 h-6" icon-name="#icon-geciweidianji" @click="showLyric = !showLyric"></icon-svg>
                    </div>
                    <!-- 上一首 -->
                    <div @click="prev" class="z-20">
                    ...
                    <!-- 播放/暂停 -->
                    <div @click="togglePlay" class="z-20">
                    ...
                    <!-- 播放列表 -->
                    <div class="cursor-pointer flex items-center z-20" @click="showPlayList = true">
                    ...
                    <PlayList />
                    <!-- 歌词模式 -->
                    <Lyric @handle-close="handleClose" :showLyric="showLyric" />
                </div>
            </div>
        </div>
    </div>
