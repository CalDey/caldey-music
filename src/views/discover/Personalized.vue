<template>
    <div class="safe-container">
        ...
        <div v-if="personalized.length > 0" class="grid grid-flow-row grid-cols-2 lg:grid-cols-4 gap-5">
            <div v-for="(item, index) in personalized" :key="index" @click="router.push({name: 'PlaylistDetail', query: {id: item.id}})">
                <CoverItem :img-url="item.picUrl" :play-count="item.playCount" show-play-count />
