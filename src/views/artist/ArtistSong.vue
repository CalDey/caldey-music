        ...
        <div v-if="hotSongsList.length > 0">
            <div class="flex justify-end mr-4 my-2">
                <el-button type="primary" round @click="playAll">
                    <svg class="w-4 h-4 mr-2" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-ba633cb8=""><path fill="currentColor" d="M896 529.152V512a384 384 0 1 0-768 0v17.152A128 128 0 0 1 320 640v128a128 128 0 1 1-256 0V512a448 448 0 1 1 896 0v256a128 128 0 1 1-256 0V640a128 128 0 0 1 192-110.848zM896 640a64 64 0 0 0-128 0v128a64 64 0 0 0 128 0V640zm-768 0v128a64 64 0 0 0 128 0V640a64 64 0 1 0-128 0z"></path></svg>
                    播放全部
                </el-button>
            </div>
            <el-table :data="hotSongsList" :header-cell-style="{background: 'rgba(153,153,153,.1)'}" class="w-full mb-20">
                <el-table-column align="center" width="60" >
                    <template #default="scope">
                        ...
                        <div v-else @click="play(scope.row.id)">
                            <span class="hover-icon-1 text-center cursor-pointer">{{scope.$index + 1}}</span>
                ...
                <el-table-column label="歌曲" align="center">
                    <template #default="scope">
                        <div class="flex flex-col justify-start items-center">
                            <el-avatar class="flex-shrink-0" shape="square" :src="scope.row.al.picUrl"></el-avatar>
